...
const NotificationsBody: FC<INotificationsBody> = ({ notifications }) => {
  ...
  return (
    <div className="w-full  h-[494px] flex flex-col gap-[27px] bg-white  rounded-b-4xl rounded-tr-4xl pt-[28px] pb-9 pl-[22.3px] pr-[30px]  ">
      <h4 className="font-semibold text-semibold leading-[27px]">Notificari</h4>
      <div className="flex flex-col gap-[25px] h-full overflow-y-auto custom-scroll">
